...
describe('TodoList', () => {
  ...
  it('returns all items, shortened to less than 20 char if too long', () => {
    // set up
    const item1 = {
      id: 1,
      text: 'turn the heating on!...',
    ...
    // execute
    todoList.create('turn the heating on! Also check the boiler!')
    todoList.create('Do the washing up')
    todoList.showAll()

    // verify
    expect(todoList.itemsShortened).toEqual(expected)
  })
